...
import us.bibos.notifier.Notifier.DoNotify;
import us.bibos.notifier.Notifier.HuntingNotifier;
import us.bibos.notifier.Probe.PNDWikiProbe.NotificationProbeData;
import us.bibos.notifier.Probe.ProbeData.ProbeData;
import us.bibos.notifier.Utils.DateTimeUtil;

import static us.bibos.notifier.Utils.Constants.APP_TAG;
import static us.bibos.notifier.Utils.Constants.NUM_GROUPS;
import static us.bibos.notifier.Utils.Constants.ONE_HOUR;
...
import static us.bibos.notifier.Utils.DateTimeUtil.getDateFromChineseMonthDay;
import static us.bibos.notifier.Utils.DateTimeUtil.getZonedYear;
    ...
    private void processDateTimeInfo(String dateStr) {
        try {
            ...
            if (difference > 0 && difference < ONE_HOUR) {
                DoNotify notifier = new HuntingNotifier("Hunt time!!",
